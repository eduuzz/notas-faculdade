      ...
      <div className="bg-[var(--bg-modal)] border border-[var(--border-input)] rounded-3xl p-6 max-w-md w-full shadow-2xl">
        ...
        {loading ? (
          ...
          <div className="py-4">
            ...
            <button onClick={loadToken} className="text-sm text-violet-400 hover:underline">Tentar novamente</button>
          </div>
        ) : token ? (
          <div className="space-y-4">
            <div className="flex items-center gap-2 p-3 rounded-xl bg-[var(--bg-input)] border border-[var(--border-input)]">
              <Link size={16} className="text-violet-400 shrink-0" />
          ...
          <div className="text-center py-4">
            ...
            <button onClick={loadToken} className="px-4 py-2 rounded-xl bg-violet-500/20 text-violet-400 hover:bg-violet-500/30 text-sm font-medium transition-all">
              Gerar Novo Link
            </button>
          </div>
        )}
